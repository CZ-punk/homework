...
public class UserControllerTest {
  ...
  public void signup() throws Exception {
    // given
    SignupRequest request = new SignupRequest("username", "password", "01012345678");
  ...
  public void sign() throws Exception {
    ...
    accessToken = JsonPath.read(responseBody, "$.token");
  ...
  public void RoleCheck_USER() throws Exception {
    ...
    ResultActions resultActions =
        mockMvc
            .perform(get("/api/user/user").header("Authorization", "Bearer " + accessToken))
            .andDo(print());
  ...
  public void RoleCheck_ADMIN() throws Exception {
    ...
    ResultActions resultActions =
        mockMvc
            .perform(get("/api/user/admin").header("Authorization", "Bearer " + accessToken))
            .andDo(print());
    // then

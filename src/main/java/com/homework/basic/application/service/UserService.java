...
public class UserService {
    ...
    public ResponseDto<?> signup(SignupDto signupDto) {
        ...
        userRepository.save(User.toUser(signupDto.username(), encodedPassword, signupDto.phoneNumber()));
    ...
    public ResponseDto<?> sign(LoginDto loginDto) {
        User user = userRepository.findByUsername(loginDto.username())
                .orElseThrow(() -> new UserException(HttpStatus.NOT_FOUND, "not found user by username = " + loginDto.username()));
